...
void sunpos(cTime udtTime,cLocation udtLocation, cSunCoordinates *udtSunCoordinates)
{
    ...
    // Calculate local coordinates ( azimuth and zenith angle ) in degrees
    {
        ...
        udtSunCoordinates->dInclinationAngle = (acos( dCos_Latitude*dCos_HourAngle
        ...
        dParallax=(dEarthMeanRadius/dAstronomicalUnit)
                  *sin(udtSunCoordinates->dInclinationAngle);
        udtSunCoordinates->dInclinationAngle=90-((udtSunCoordinates->dInclinationAngle
                                         + dParallax)/rad);
        udtSunCoordinates->test = 2.66666;
    }
}
